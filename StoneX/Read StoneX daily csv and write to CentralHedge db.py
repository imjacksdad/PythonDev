                    ...
                    for row in csv_reader:
                        if line_count == 0:
                            ...
                            ([RECID],[Firm],[OfficeCode],[FimatAcctCode],[AccountType], \
                             ...
                             [CardNumber],[GiveINGiveOUTCode],[GiveINFirmNum],[OrderType],[DeleteCode],\
                             [RoutingCode],[GMIOperatorID],[TradePriceDecimal],[CustomerName],[Instrument],\
                             [TradePriceFractional],[ClosePriceFractional],[Value],[Buys],[Sells],\
                             [CUSIP],[Fee1],[Fee2],[Fee3],[Fee4],\
                             [Fee5],[Fee6],[Fee7],[Fee8],[Fee9],\
                             [PGICHG],[PBKCHG],[POTHER],[PFUFE1],[PFUFE2],\
                             [PFUFE3],[PFUFE4],[PFUFE5],[PFUFE6],[PFUFE7],\
                             [PFUFE8],[PFUFE9],[PFUGIV],[PFUBKG],[PFUOTH],\
                             [Delta],[Commission],[DealID],[SettleDate],[UnderlyingPrice],\
                             [CommentCode],[RecordLoaded],[PositionType]) \
                            VALUES \
                            (?,?,?,?,?,?,?,?,?,?,\
                            ?,?,?,?,?,?,?,?,?,?,\
                            ?,?,?,?,?,?,?,?,?,?,\
                            ...
                            val=[row[0],row[1],row[2],row[3],row[4],\
                                 ...
                                 row[30],row[31],row[32],row[31],row[34],\
